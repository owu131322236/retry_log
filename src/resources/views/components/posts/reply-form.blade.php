<div id="replyForm" class="hidden fixed bg-black/50 flex items-center justify-center w-full h-full">
            ...
            <div>
                <div class="flex">
                    <div class="flex flex-col gap-3 items-center flex-shrink-0 mr-3">
                        <img alt="User avatar" class="w-10 h-10 rounded-full" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAPVLwZiBlE-9TtmmyeeE6cSu_zDvD8U09t6jPhWzAFeXEfCitMJ6lb437eGTvNUB1t4GufDcoFMFzjSOzugkXvDX60m7itRvuJrrjdr3AOfc3UzlGXhJEcb1ZldoOvDRt0VOehsI34HZSrbCjXP4psB6qlXSxdy0e8wHpSskRu6MKAqto2fPbtQw40_zsaZUaIIW8rMnwgkO15dDvVF6sUSs4a4tTAaQh4VbaNqiijtBdm7xijI66ObaaML8VFpu435psdq8-_yUPV" />
                ...
                <div class="flex mt-2">
                    <div class="flex-shrink-0 mr-3">
                        <img alt="Replying user avatar" class="w-10 h-10 rounded-full" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAnFNS6rNWKuGH3cAaFeD_9BmdSXmBZ_fKfhis_gL12MZXsnGmlb83RqVB2M-IJF--mZG51rTzJmov-Rk2N5OMFwb9cJferjiljn2cK_EpYZZ5vlrHB3iU0OGG_x-vlc6zOw_lN_BWN9ip5Au_xcvj_7d3ZFPMDdHZuuNEFAvRwIrrNgx6TC4Uk8t_5q0aq3uQxWEdhWyEg5YB-75ryRUmHEzFp91EfEWfkCGsiGz-20k3h0AkAFya8hz9KfJ_IlNC8ZCCN04B8bAOM" />
                    </div>
