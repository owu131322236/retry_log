...
onclick="goToDetail(event)">
    <div class="flex w-full flex-row items-start justify-start gap-3 p-4">
        <a href="{{ route('mypage', [$post->user])}}">
        <img
            src="{{ $post->user()->icon ?? asset('images/icons/default.jpg') }}"
            alt="User Icon"
        ...
        <div class="flex h-full flex-1 flex-col items-start justify-start">
            <div class="flex w-full flex-row items-start justify-start items-center">
                <p class="text-[#0d0d1c] text-base font-bold leading-normal tracking-[0.015em] m-1">{{ $post->user->name }}</p>
                ...
                <p class="text-[#49499c] text-base font-normal leading-normal m-4">{{ $post->created_at }}</p>
            </div>
            <p class="text-[#0d0d1c] text-base font-normal leading-normal">{{$post->content}}</p>
        </div>
    </div>
