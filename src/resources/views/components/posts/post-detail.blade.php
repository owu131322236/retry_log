    ...
    <div class="flex w-full flex-row items-start justify-start gap-3 p-4">
        ...
        <div class="flex h-full flex-1 flex-col items-start justify-start">
            <div class="flex w-full flex-row items-start justify-start items-center">
                <p class="text-[#0d0d1c] text-base font-bold leading-normal tracking-[0.015em] m-1">Olivia Hayes</p>
                ...
                <p class="text-[#49499c] text-base font-normal leading-normal m-4">6h ago</p>
            </div>
            <p class="text-[#0d0d1c] text-base font-normal leading-normal">Had a great meditation session this evening. Feeling calm and centered. #Meditation</p>
        </div>
    </div>
